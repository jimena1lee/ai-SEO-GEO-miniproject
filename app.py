...
with st.sidebar:
    ...
    brand_name = st.text_input("브랜드명", placeholder="예: 체스트몰")
    product_name = st.text_input("상품명", placeholder="예: 토피브릴 심플 린넨 미니 원피스")
...
if platform == "Cafe24":
    ...
    if input_method == "URL 직접 입력":
        url_input = st.text_input(
            "상품 페이지 URL",
            placeholder="예: https://jimena1lee.cafe24.com/product/detail.html?product_no=28"
        )
